...
function buildCompactEmailHtml(editor: Editor) {
  ...
  let html = `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>${css}</style></head><body>${body}</body></html>`;
  let previous: string;
  do {
    previous = html;
