        ...
        <>
          ...
          <div className="mb-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
            ...
            <StatCard
              ...
              value={stats?.author_applications.pending ?? 0}
            ...
            <div>
              ...
              <div className="space-y-2">
                <ActionCard
                  ...
                  desc={`${stats?.articles.pending ?? 0} pending · ${stats?.articles.in_review ?? 0} in review`}
                ...
                <ActionCard
                  ...
                  label="Author Applications"
                  desc={`${stats?.author_applications.pending ?? 0} pending applications`}
                ...
                {totalUsers === 0 ? (
                  ...
                  <div className="space-y-3">
                    {(['member', 'editor', 'admin', 'super-admin'] as const).map((r) => {
                      const count = stats?.users.by_role[r] ?? 0;
              ...
              <div className="rounded-2xl border border-white/[0.07] bg-white/[0.02] p-5">
                <div className="space-y-2">
                  {([
                    ...
                    { key: 'inReview',  label: 'In Review',       color: 'bg-blue-500',    val: stats?.articles.in_review ?? 0 },
          ...
          {/* ── Recent submissions ── */}
          {(stats?.recent_submissions.length ?? 0) > 0 && (
            <div>
